          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mt-0 pl-6 pr-6">
                            <Dialog open={addQuestionDialogOpen} onOpenChange={setAddQuestionDialogOpen}>
                                <DialogTrigger asChild>
                                    <Button className="bg-primary cursor-pointer hover:bg-primary/90 text-primary-foreground w-full sm:w-auto">
                                ...
                                <DialogContent 
                                    className="max-h-[90vh] overflow-y-auto w-[95vw] sm:w-[90vw] md:w-[80vw] lg:w-[70vw] xl:w-[60vw] max-w-4xl min-w-[320px] mx-2 sm:mx-4"
                                >
                        ...
                        {/* Edit Question Dialog */}
                            <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
                                <DialogContent 
                                    className="space-y-4 py-4 gap-4 max-h-[90vh] overflow-y-auto w-[95vw] sm:w-[90vw] md:w-[80vw] lg:w-[70vw] xl:w-[60vw] max-w-4xl min-w-[320px] mx-2 sm:mx-4"
                                >
                                    <DialogHeader className="pt-0 mt-0">
                                        <DialogTitle className="flex items-center space-x-2">
                                                ...
                                                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                                                    ...
                                                    {question.difficultyLevel && (
                                                        <div className={`text-xs font-medium px-2 py-1 rounded-full ${
                                                            question.difficultyLevel.toLowerCase() === 'easy' ? 'bg-green-100 text-green-800' :
